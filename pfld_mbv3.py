...
def pfld_inference_for_mobileNetV3_large(input, weight_decay, batch_norm_params, num_labels, depth_multi, min_depth=1):
    layers = [
...
def pfld_inference_for_mobileNetV3_small(input, weight_decay, batch_norm_params, num_labels, depth_multi, min_depth=1):
    layers = [
