...
#file_list=/data/prepro_dataset/hardrotated_train_baobab_0716_lipmf_pitchyaw_aug_pcn_lipclean/list.txt
# test_list=/data/prepro_dataset/hardrotated_test_baobab_0716_lipmf_pitchyaw_aug_pcn_lipclean/list.txt
