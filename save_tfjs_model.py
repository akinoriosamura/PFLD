...
def create_save_model(args, model_dir, graph, sess):
    ...
    signature = tf.saved_model.predict_signature_def(
        {"image_batch": image_batch}, outputs={"fc/BiasAdd": landmarks_pre}
    )
